    ...
    SelectedCameras& selected_cameras)
{
    ...
    RenderingContextStack::primary_scene_node_resources().instantiate_child_renderable(OBJ_SLIDE, ChildInstantiationOptions{
        ...
        .scene_node = scene_node_slide.ref(CURRENT_SOURCE_LOCATION),
    ...
    {
        AbsoluteMovableSetter ams_slide{scene, scene.get_node(OBJ_SLIDE, CURRENT_SOURCE_LOCATION), OBJ_SLIDE, std::move(rb_slide), CURRENT_SOURCE_LOCATION};
        AbsoluteMovableSetter ams_box{scene, scene.get_node(OBJ_BOX, CURRENT_SOURCE_LOCATION), OBJ_BOX, std::move(rb_box), CURRENT_SOURCE_LOCATION};

        pe.rigid_bodies_.add_rigid_body(*ams_slide.absolute_movable, triangles_slide, {}, {}, CollidableMode::COLLIDE);
        pe.rigid_bodies_.add_rigid_body(*ams_box.absolute_movable, triangles_box, {}, {}, CollidableMode::COLLIDE | CollidableMode::MOVE);
