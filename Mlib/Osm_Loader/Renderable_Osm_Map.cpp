    ...
    SmallInstancesQueues& instances_queue) const
{
    ...
    };
    {
        ...
        if (omr_.terrain_styles_.near_grass_terrain_style_.is_visible()) {
            ...
            {
                grass_triangles.push_back({ omr_.terrain_styles_.near_grass_terrain_style_, tit->second });
            }
        ...
        if (omr_.terrain_styles_.near_wayside1_grass_terrain_style_.is_visible()) {
            ...
            {
                grass_triangles.push_back({ omr_.terrain_styles_.near_wayside1_grass_terrain_style_, tit->second });
            }
        }
        if (omr_.terrain_styles_.near_wayside2_grass_terrain_style_.is_visible()) {
            ...
            {
                grass_triangles.push_back({ omr_.terrain_styles_.near_wayside2_grass_terrain_style_, tit->second });
            }
        }
        if (omr_.terrain_styles_.near_flowers_terrain_style_.is_visible()) {
            ...
            {
                grass_triangles.push_back({ omr_.terrain_styles_.near_flowers_terrain_style_, tit->second });
            }
        }
        if (omr_.terrain_styles_.near_trees_terrain_style_.is_visible()) {
            ...
            {
                grass_triangles.push_back({ omr_.terrain_styles_.near_trees_terrain_style_, tit->second });
            }
        }
    ...
    if (omr_.terrain_styles_.no_grass_decals_terrain_style_.is_visible()) {
        for (const auto& lst : omr_.tls_no_grass_) {
            add_triangles(
                *lst,
                omr_.scene_node_resources_,
                omr_.terrain_styles_.no_grass_decals_terrain_style_,
                omr_.scale_,
                nullptr);
        }
    }
