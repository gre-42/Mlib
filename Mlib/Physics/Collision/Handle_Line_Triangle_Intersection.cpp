            ...
            if (c.o0->mass() != INFINITY) {
                NormalContactInfo2* ci = new NormalContactInfo2{
                    ...
                    [c, plane](float lambda_final){
                        for(auto& c0 : c.o0->collision_observers_) {
                            c0->notify_impact(c.o1->rbi_.rbp_, c.o1->collision_observers_, CollisionRole::PRIMARY, plane.normal, lambda_final, c.base_log);
                        }
                        for(auto& c1 : c.o1->collision_observers_) {
                            c1->notify_impact(c.o0->rbi_.rbp_, c.o0->collision_observers_, CollisionRole::SECONDARY, plane.normal, lambda_final, c.base_log);
                        }
                    }};
