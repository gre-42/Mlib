...
const menutext_t menuPODBotMain =
{
   0x2ff,
   " \\yPlease choose:\\w\n"
   "\n"
...
const menutext_t menuPODBotAddBotSkill =
{
...
const menutext_t menuPODBotAddBotPersonality =
{
   0x217,
...
const menutext_t menuPODBotAddBotTeam =
{
   0x213,
...
const menutext_t menuPODBotAddBotTModel =
{
   0x01f,
...
const menutext_t menuPODBotAddBotCTModel =
{
   0x01f,
...
const menutext_t menuPODBotFillServerSkill =
{
   0x27f,
   " \\yPlease choose a Skill:\\w\n"
   "\n"
...
const menutext_t menuPODBotFillServerPersonality =
{
   0x217,
   " \\yPlease choose a Personality:\\w\n"
   "\n"
...
const menutext_t menuPODBotFillServerTeam =
{
   0x213,
   " \\yPlease choose a Team:\\w\n"
   "\n"
...
const menutext_t menuPODBotFillServerTModel =
{
   0x01f,
   " \\yPlease choose a Terrorist Model:\\w\n"
   "\n"
...
const menutext_t menuPODBotFillServerCTModel =
{
   0x01f,
   " \\yPlease choose a CT Model:\\w\n"
   "\n"
...
const menutext_t menuPODBotKickBot1 =
{
   0x0,
   NULL
};

const menutext_t menuPODBotKickBot2 =
{
   0x0,
   NULL
};

const menutext_t menuPODBotKickBot3 =
{
   0x0,
   NULL
};

const menutext_t menuPODBotKickBot4 =
{
   0x0,
   NULL
};

const menutext_t menuPODBotWeaponMode =
{
   0x27f,
   " \\yWeapon Mode:\\w\n"
   "\n"
...
const menutext_t menuWpSetRadius =
{
   0x3ff,
   "\n"
   "\n"
...
const menutext_t menuWpSetFlags =
{
   0x3ff,
   "\n"
   "\n"
...
const menutext_t menuWpSetTeam =
{
   0x207,
   "\n"
   "\n"
...
const menutext_t menuWpAddPath =
{
   0x207,
   "\n"
   "\n"
...
const menutext_t menuWpDeletePath =
{
   0x003,
   "\n"
   "\n"
...
const menutext_t menuWpOptions1 =
{
...
const menutext_t menuWpOptions2 =                     // KWo - 29.03.2008
{
   0x283,
   "\n"
   "\n"
...
const menutext_t menuWpAutoPathMaxDistance =
{
   0x27f,
   "\n"
   "\n"
