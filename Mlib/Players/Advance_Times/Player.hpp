...
public:
    ...
    void append_delete_externals(SceneNode* container_node, const std::function<void()>& delete_externals);
...
private:
    ...
    std::list<std::pair<const SceneNode*, std::function<void()>>> delete_externals_;
