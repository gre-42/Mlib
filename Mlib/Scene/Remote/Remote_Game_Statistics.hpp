...
class RemoteGameStatistics final: public IIncrementalObject {
public:
    explicit RemoteGameStatistics(
        IoVerbosity verbosity,
        const DanglingBaseClassRef<PhysicsScene>& physics_scene);
    ~RemoteGameStatistics();
    static DanglingBaseClassPtr<RemoteGameStatistics> try_create_from_stream(
...
private:
    ...
    uint32_t full_retransmission_age_;
