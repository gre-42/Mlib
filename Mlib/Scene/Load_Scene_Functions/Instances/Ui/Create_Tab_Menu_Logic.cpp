...
void CreateTabMenuLogic::execute(const LoadSceneJsonUserFunctionArgs& args)
{
    ...
    RenderingContextGuard rcg{ RenderingContext{
        ...
        .particles_resources = primary_rendering_context.particles_resources,    // read by TabMenuLogic
    ...
    auto tab_menu_logic = std::make_shared<TabMenuLogic>(
        ...
        [macro_line_executor = args.macro_line_executor, reload_transient_objects]() {
            if (!reload_transient_objects.empty()) {
                macro_line_executor(JsonView{reload_transient_objects}, nullptr, nullptr);
