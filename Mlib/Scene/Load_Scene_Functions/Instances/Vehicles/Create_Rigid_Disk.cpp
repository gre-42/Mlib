...
void CreateRigidDisk::execute(const LoadSceneJsonUserFunctionArgs& args) const
{
    ...
    (*this)(CreateRigidDiskArgs{
        ...
        args.arguments.at<EFixedArray<float, 3>>(KnownArgs::com, fixed_zeros<float, 3>()) * meters,
...
DanglingBaseClassRef<RigidBodyVehicle> CreateRigidDisk::operator () (const CreateRigidDiskArgs& args) const
{
