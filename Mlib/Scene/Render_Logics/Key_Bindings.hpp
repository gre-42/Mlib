...
struct VehicleControllerIdleBinding;
...
public:
    ...
    void add_vehicle_controller_idle_binding(const VehicleControllerIdleBinding& b);
...
private:
    ...
    std::list<VehicleControllerIdleBinding> vehicle_controller_idle_bindings_;
