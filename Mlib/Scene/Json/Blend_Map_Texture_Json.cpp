...
BlendMapTexture Mlib::blend_map_texture_from_json(const JsonMacroArguments& j)
{
    ...
    return {
        ...
        .normal = j.at<EOrderableFixedArray<float, 3>>(KnownArgs::normal),
        .cosines = j.at<EOrderableFixedArray<float, 4>>(KnownArgs::cosine),
        .discreteness = j.at<float>(KnownArgs::discreteness, 2.f),
        .scale = j.at<EOrderableFixedArray<float, 2>>(KnownArgs::scale),
