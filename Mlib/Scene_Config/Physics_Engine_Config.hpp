...
struct PhysicsEngineConfig {
    ...
    CompressedScenePos dilation_radius = (CompressedScenePos)(20.f * meters); // Maximum vehicle radius
    ...
    bool no_slip = false;
    float parking_brake_velocity = 5.f * kph;
    float slow_velocity = 40.f * kph;
