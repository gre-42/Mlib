        ...
        auto traverse_triangle = [&](const TriangleAndSeed& t){
            ...
            tiis.sample_triangle(
                    ...
                    const ParsedResourceName& prn)
                {
                    ...
                    const auto& scvas = scene_node_resources_.get_gpu_vertex_data_group(prn.name);
...
ScenePos RenderableTriangleSampler::max_center_distance2(BillboardId billboard_id) const {
    return INFINITY;
}
