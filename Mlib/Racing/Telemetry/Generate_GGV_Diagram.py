...
def generate_ggv_diagram(csv_file="/tmp/telemetry_log.csv"):
    ...
    plt.scatter(df['g_lat_ms2'], df['g_lon_ms2'],
    ...
    g_limit = 9.8
    plot_limit = g_limit * 5

    circle1 = plt.Circle((0, 0), radius=g_limit, edgecolor='k', fill=False)
