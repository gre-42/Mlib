...
IGpuObjectFactory& RenderingContextStack::primary_gpu_object_factory() {
    return instance().gpu_object_factory;
}

IGpuVertexArrayRenderer& RenderingContextStack::primary_gpu_vertex_array_renderer() {
    return instance().gpu_vertex_array_renderer;
}
