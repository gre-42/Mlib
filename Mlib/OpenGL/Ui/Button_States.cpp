...
#include <Mlib/OpenGL/Input_Map/Gamepad_Button_Map.hpp>
#include <Mlib/OpenGL/Input_Map/Joystick_Axes_Map.hpp>
#include <Mlib/OpenGL/Input_Map/Key_Events.hpp>
#include <Mlib/OpenGL/Input_Map/Key_Map.hpp>
#include <Mlib/OpenGL/Input_Map/Mouse_Button_Map.hpp>
#include <Mlib/OpenGL/Input_Map/Tap_Analog_Axes_Map.hpp>
#include <Mlib/OpenGL/Input_Map/Tap_Button_Map.hpp>
#include <Mlib/OpenGL/Key_Bindings/Base_Key_Binding.hpp>
#include <Mlib/OpenGL/Key_Bindings/Filter_Type.hpp>
#include <cmath>
#include <iostream>
#include <mutex>
#include <stdexcept>
    ...
    FilterType filter_type) const
{
    ...
    if (gamepad_id > GLFW_JOYSTICK_LAST) {
        throw std::runtime_error("Unknown gamepad ID");
    }
    ...
    throw std::runtime_error("Unknown filter type: " + std::to_string((int)filter_type));
}
