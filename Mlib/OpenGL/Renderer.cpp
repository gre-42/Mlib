    ...
    , frame_time_{ std::move(frame_time) }
{
    ...
    if (!frame_time_) {
        throw std::runtime_error("frame_time not set");
    }
}
...
static void cursor_callback(GLFWwindow* window, double xpos, double ypos)
{
    ...
    try {
        ...
        // From: https://www.glfw.org/docs/3.1/group__input.html#ga04b03af936d906ca123c8f4ee08b39e7
        //   Do not use this function to implement things like camera controls. GLFW already provides
        //   the GLFW_CURSOR_DISABLED cursor mode that hides the cursor, transparently re-centers it
        //   and provides unconstrained cursor motion. See glfwSetInputMode for more information.
