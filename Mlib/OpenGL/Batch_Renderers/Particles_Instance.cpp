...
static ClearOnUpdate get_clear_on_update(ParticleType particle_type) {
    switch (particle_type) {
        ...
        case ParticleType::WATER_WAVE: throw std::runtime_error("Water waves do not require a particles instance");
...
ParticlesInstance::ParticlesInstance(
    ...
    , dynamic_instance_buffers_{ std::make_shared<DynamicInstanceBuffers>(
        ...
        max_num_instances,
        integral_cast<BillboardId>(vertex_data->mesh_meta().material.billboard_atlas_instances.size()),
