...
RenderToTextureLogic::RenderToTextureLogic(
    ...
    , color_texture_name_{ FPath::from_variable_and_hash(std::move(color_texture_name)) }
    , depth_texture_name_{ FPath::from_variable_and_hash(std::move(depth_texture_name)) }
