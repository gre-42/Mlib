...
#include <Mlib/OpenGL/Raster/D3d8_Raster.hpp>
#include <Mlib/OpenGL/Raster/Gl3_Raster.hpp>
#include <Mlib/OpenGL/Raster/Ps2_Raster.hpp>
    ...
    const RasterConfig& raster_config) const
{
    ...
    case 4:
    default:
        throw std::runtime_error("Invalid raster depth");
    }
