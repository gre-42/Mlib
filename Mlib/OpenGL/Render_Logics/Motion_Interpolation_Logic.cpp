...
void MotionInterpolationLogic::ensure_initialized() {
    if (!initialized_) {
        ...
        // --------------------
        rp_no_interpolate_.allocate(simple_vertex_shader_text(), fragment_shader_text(/* interpolate = */false));
        ...
        if (interpolation_type_ == InterpolationType::MEAN) {
            rp_interpolate_mean_.allocate(simple_vertex_shader_text(), fragment_shader_text(/* interpolate = */true));
        ...
        if (interpolation_type_ == InterpolationType::OPTICAL_FLOW) {
            rp_interpolate_of_diff_.allocate(simple_vertex_shader_text(), optical_flow_diff1_fragment_shader_text());
            ...
            rp_interpolate_of_finalize_.allocate(simple_vertex_shader_text(), optical_flow_fragment_shader_text());
            ...
            rp_interpolate_of_apply_.allocate(simple_vertex_shader_text(), optical_flow_apply_fragment_shader_text());
    ...
    const RenderSetup* setup)
{
    ...
    if (!render_config.motion_interpolation) {
        ...
        if (render_texture) {
            RenderedSceneDescriptor rsd{.external_render_pass = {frame_id.external_render_pass.observer, ExternalRenderPassType::STANDARD, frame_id.external_render_pass.time}, .time_id = frame_id.time_id };
        ...
        if (!interpolate) {
            RenderedSceneDescriptor rsd_r{.external_render_pass = {frame_id.external_render_pass.observer, ExternalRenderPassType::STANDARD, frame_id.external_render_pass.time}, .time_id = (frame_id.time_id + 2) % 4 };
            ...
            RenderedSceneDescriptor rsd_r0{.external_render_pass = {frame_id.external_render_pass.observer, ExternalRenderPassType::STANDARD, frame_id.external_render_pass.time}, .time_id = (frame_id.time_id + 1) % 4 };
            RenderedSceneDescriptor rsd_r1{.external_render_pass = {frame_id.external_render_pass.observer, ExternalRenderPassType::STANDARD, frame_id.external_render_pass.time}, .time_id = (frame_id.time_id + 3) % 4 };
