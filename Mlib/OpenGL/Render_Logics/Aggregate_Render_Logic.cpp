...
AggregateRenderLogic::AggregateRenderLogic(
    ...
    , small_sorted_instances_renderers_{ std::make_shared<ArrayInstancesRenderers>(
        RenderingContextStack::primary_gpu_object_factory(),
        RenderingContextStack::primary_gpu_vertex_array_renderer()) }
    , large_aggregate_renderer_{ std::make_shared<AggregateArrayRenderer>(rendering_resources) }
    , large_instances_renderer_{ std::make_shared<ArrayInstancesRenderer>(
        RenderingContextStack::primary_gpu_object_factory(),
        RenderingContextStack::primary_gpu_vertex_array_renderer()) }
{}
