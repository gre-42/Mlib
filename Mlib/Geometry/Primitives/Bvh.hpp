...
#include <Mlib/List_Of_Pairs/List_Of_Pair_Adapters.hpp>
#include <Mlib/List_Of_Pairs/Thread_Safe_List_Of_Shared_Pairs.hpp>
...
public:
    ...
    AxisAlignedBoundingBox<TPosition, tndim> move_a_little() {
    ...
    void move_a_lot() {
        *this = repackaged(max_size_, level_);
    }
