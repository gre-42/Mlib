...
enum class PhysicsMaterial: uint32_t {
    ...
    ATTR_SLIPPERY               = (1 << 8),
    ATTR_ANIMATED_COLOR         = (1 << 9),
    ATTR_ANIMATED_NORMAL        = (1 << 10),
    ATTR_LIQUID                 = (1 << 11),
    OBJ_ALIGNMENT_PLANE         = (1 << 12),
    OBJ_CHASSIS                 = (1 << 13),
    OBJ_TIRE_LINE               = (1 << 14),
    OBJ_GRIND_CONTACT           = (1 << 15),
    OBJ_GRIND_LINE              = (1 << 16),
    OBJ_ALIGNMENT_CONTACT       = (1 << 17),
    OBJ_BULLET_LINE_SEGMENT     = (1 << 18),
    OBJ_BULLET_MESH             = (1 << 19),
    OBJ_HITBOX                  = (1 << 20),
    OBJ_DISTANCEBOX             = (1 << 21),
    OBJ_GRASS                   = (1 << 22),
