...
int tti::tri_tri_overlap_test_3d(const real p1[3], const real q1[3], const real r1[3],
                                 const real p2[3], const real q2[3], const real r2[3]);


int tti::coplanar_tri_tri3d(const real  p1[3], const real  q1[3], const real  r1[3],
                            const real  p2[3], const real  q2[3], const real  r2[3],
                            const real  N1[3], const real  N2[3]);


int tti::tri_tri_overlap_test_2d(const real p1[2], const real q1[2], const real r1[2],
                                 const real p2[2], const real q2[2], const real r2[2]);


int tti::tri_tri_intersection_test_3d(const real p1[3], const real q1[3], const real r1[3],
                                      const real p2[3], const real q2[3], const real r2[3],
                                      int * coplanar,
...
static int ccw_tri_tri_intersection_2d(const real p1[2], const real q1[2], const real r1[2],
                                       const real p2[2], const real q2[2], const real r2[2]) {
