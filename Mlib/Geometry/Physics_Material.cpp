...
std::string Mlib::physics_material_to_string(PhysicsMaterial p) {
    static const std::map<PhysicsMaterial, std::string> m{
        ...
        {PhysicsMaterial::SURFACE_BASE_TARMAC, "surface_base_tarmac"},
        {PhysicsMaterial::SURFACE_BASE_GRAVEL, "surface_base_gravel"},
        {PhysicsMaterial::SURFACE_BASE_SNOW, "surface_base_snow"},
        {PhysicsMaterial::SURFACE_BASE_ICE, "surface_base_ice"},
        {PhysicsMaterial::SURFACE_BASE_SAND, "surface_base_sand"},
        {PhysicsMaterial::SURFACE_BASE_GRASS, "surface_base_grass"},
        {PhysicsMaterial::SURFACE_BASE_DIRT, "surface_base_dirt"},
        {PhysicsMaterial::SURFACE_BASE_TIRE, "surface_base_tire"},
        {PhysicsMaterial::SURFACE_BASE_STONE, "surface_base_stone"},
        {PhysicsMaterial::SURFACE_BASE_FOLIAGE, "surface_base_foliage"}
    };
    auto it = m.find(p);
    if (it == m.end()) {
        return "PhysicsMaterial(" + std::to_string((uint32_t)p) + ')';
    }
    return it->second;
}
