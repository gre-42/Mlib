...
{
    FixedArray<TData, 3> edge1 = pos1 - pos0;
    FixedArray<TData, 3> edge2 = pos2 - pos0;
    ...
    FixedArray<TData, 3> tangent1{
        f * (deltaUV1(1) * edge1(0) - deltaUV0(1) * edge2(0)),
        f * (deltaUV1(1) * edge1(1) - deltaUV0(1) * edge2(1)),
        f * (deltaUV1(1) * edge1(2) - deltaUV0(1) * edge2(2))};
