...
if(NOT DETOUR_LIBRARY)
    find_library(DETOUR_LIBRARY_RELEASE NAMES Detour HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES Detour/Release Recast/RelWithDebInfo lib Detour)
...
if(NOT DEBUGUTILS_LIBRARY)
    find_library(DEBUGUTILS_LIBRARY_RELEASE NAMES DebugUtils HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES DebugUtils/Release Recast/RelWithDebInfo lib DebugUtils)
