...
if(NOT RECAST_LIBRARY)
    find_library(RECAST_LIBRARY_RELEASE NAMES Recast HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES lib Recast)
    find_library(RECAST_LIBRARY_DEBUG NAMES Recast-d HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES lib Recast)
...
if(NOT DETOUR_LIBRARY)
    find_library(DETOUR_LIBRARY_RELEASE NAMES Detour HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES lib Detour)
    find_library(DETOUR_LIBRARY_DEBUG NAMES Detour-d HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES lib Detour)
    include(SelectLibraryConfigurations)
...
if(NOT DEBUGUTILS_LIBRARY)
    find_library(DEBUGUTILS_LIBRARY_RELEASE NAMES DebugUtils HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES lib DebugUtils)
    find_library(DEBUGUTILS_LIBRARY_DEBUG NAMES DebugUtils-d HINTS ${RECASTNAVIGATION_ROOT} PATH_SUFFIXES lib DebugUtils)
    include(SelectLibraryConfigurations)
...
set(RECAST_INCLUDE_DIRS ${RECAST_INCLUDE_DIR} ${RECAST_INCLUDE_DIR}/../../DebugUtils/Include)

set(DETOUR_LIBRARIES ${DETOUR_LIBRARY})
set(DETOUR_INCLUDE_DIRS ${RECAST_INCLUDE_DIR} ${RECAST_INCLUDE_DIR}/../../Detour/Include)
